...
<script type="text/javascript">
   $(document).ready(function() {
	...
	location.href="/blog/like?blog_bno=${read.blog_bno}"
            + "&page=${scri.page}"
            + "&perPageNum=${scri.perPageNum}"
            + "&searchType=${scri.searchType}"
            + "&keyword=${scri.keyword}"
...
<body>
   <div class="container">
      ...
      <div class="form-group">
         ...
         <button type="button" class="likebtn btn btn-primary">좋아요</button>
      ...
      <form name="replyForm" class="form-horizontal" method="post">
         ...
         <div class="form-group">
            ...
            <div class="col-sm-10">
               <input type="text" id="reply_writer" name="reply_writer" class="form-control" value="${read.blog_email}" readonly="readonly"/>
            </div>
         </div>   
