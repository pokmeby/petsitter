...
<body>
<h1>프로필 수정 페이지</h1>
<form name="viewForm" role="form" action="/sitter/profileEdit" method="post" enctype="multipart/form-data">
<div>
...
<input type="text" id="sitter_name" name="sitter_name" value="${profileEdit.sitter_name}" readonly="readonly" />
</div>
<div>
<label for="sitter_gender">성별</label>
<input type="text" id="sitter_gender" name="sitter_gender" value="${profileEdit.sitter_gender}" readonly="readonly"/>
</div>
<div>
...
<input type="text" id="rate" name="rate" value="${profileEdit.rate}" readonly="readonly" />
</div>
